...
class TypewiseTest(unittest.TestCase):
    ...
    def test_check_and_alert_for_TOO_HIGH(self):
        self.assertTrue(typewise_alert.check_and_alert(typewise_alert.send_to_controller, 'PASSIVE_COOLING', 50) == (True, "TOO_HIGH"))
    def test_check_and_alert_for_Invalid_param(self):
        self.assertTrue(typewise_alert.check_and_alert(typewise_alert.send_to_controller, 'WRONG_COOLING', -30) == (False, "Invalid_Param"))
